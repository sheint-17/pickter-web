...
export default function PickterGuide() {
  ...
  const items = [
    ...
    {
      icon: '⚡',
      title: '언더독 보너스 — 30% 미만 확률을 맞추면?',
      desc: '참여 당시 확률이 30% 미만인 선택지를 적중하면 RP +20 추가 지급 + 언더독 히어로 배지를 획득해요. 역배당에 도전해보세요!',
    },
    {
      icon: '🏃',
      title: 'RUN — 패널티 감수하고 나갈 수 있어요',
      desc: '마음이 바뀌면 RUN 탭에서 런할 수 있어요. 단, 참여 포인트의 25%가 패널티로 소멸돼요. 신중하게 PICK 하세요!',
    },
  ]
